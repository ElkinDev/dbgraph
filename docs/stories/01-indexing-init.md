...
**Phase:** 1 (model) + 4 (config) · **Depends on:** US-006 · **Status:** ☐ partial (model+normalizer semantics fully done in phase-1-graph-core — off/metadata/full applied, FTS body gated, bodyHash stable; config plumbing/CLI flags pending Phase 4)
...
**Phase:** 4 · **Depends on:** US-001, US-009 · **Status:** ☐ pending
