 ...
 * `pkg.version === DBGRAPH_VERSION === '1.0.0'` makes divergence mechanically impossible to
...
describe('version single-source drift guard (always-on)', () => {
  ...
  it('the single version value is exactly "1.0.0"', () => {
    // Pins the current release value so both channels report 1.0.0.
